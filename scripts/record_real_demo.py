"""Drive the deployed gemini-mantle-agent Cloud Run app through Playwright,
...
URL = "https://gemini-mantle-agent-1029931682737.us-central1.run.app/"
OUT_DIR = Path("/Users/ubl/gemini-mantle-agent/.video-build")
...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_selector("text=gemini-mantle-agent", timeout=60_000)
